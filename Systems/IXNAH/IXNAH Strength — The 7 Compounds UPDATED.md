...
**Grip limits your actual strength.**

A weak grip means you can't use the strength you have. Period. It doesn't matter how strong your back is if you can't hold the bar. It doesn't matter how powerful your pull is if the gi slips from your fingers. Grip is the bottleneck between intention and force.
...
**How IXNAH trains grip:**

Grip is NOT trained as a separate session. It is woven into every movement through equipment choices and variations:

| Grip Type | How It's Trained | Why It Matters |
|-----------|-----------------|----------------|
...
Seven patterns. Seven exercises. Every major muscle group. Every fundamental human movement. Nothing redundant. Nothing missing.

---

### 1. Pullup — The Vertical Pull

**What it trains:** Lats, biceps, grip, core (anti-extension), forearms, rear delts.

**Why it's in IXNAH:**
- Direct Judo transfer — pulling uke off balance (kuzushi) is a vertical pull
- The gold standard upper body strength test
- Grip endurance under load
- Spinal decompression between reps

**Progressions:**
1. Dead hang (30 seconds → 2 minutes)
2. Scapular pullups (engage/disengage shoulders)
3. Negative pullups (5-second lowering)
4. Band-assisted pullups
5. Full pullup (strict, no kip)
6. Weighted pullup (+10 kg → +25 kg → bodyweight ×1.5)
7. Towel pullup / Gi pullup (grip intensifier)
8. One-arm pullup (long-term — years)

**Grip integration:** Once 10+ strict pullups are achieved, rotate between:
- Standard bar (support grip baseline)
- Towel pullups (crush grip — direct Judo transfer)
- Fat bar or gi over bar (forearm/grip overload)

**Rep targets:**
- Strength: 5 × 5 weighted
...
### 2. Body Row — The Horizontal Pull

**What it trains:** Upper back (rhomboids, mid/lower traps), rear delts, biceps, grip, core stability.

**Why it's in IXNAH:**
- Pulling toward the body = clinch pull, Judo grip fighting direction
- Balances the pushup (horizontal push ↔ horizontal pull)
- Builds the postural muscles that prevent forward-head/rounded-shoulder posture
- More accessible than pullups as an entry point

**Progressions:**
1. High angle row (bar at chest height, feet close)
2. Standard body row (bar at hip height, body at ~45°)
3. Low angle row (bar at knee height, body nearly horizontal)
4. Feet-elevated row (feet on bench — hardest bodyweight version)
5. Weighted row (vest or band resistance)
6. Front lever progression (tuck → advanced tuck → full — long-term goal)

**Grip integration:** Rotate grips — overhand, underhand, neutral, towel.
...
### 3. Dip — The Vertical Push

**What it trains:** Chest (lower), triceps, anterior delts, core stability.
...
**Progressions:**
1. Bench dips (feet on ground)
2. Parallel bar dips (assisted with band)
3. Full parallel bar dip (strict — elbows to 90°, full lockout)
4. Ring dips (stability challenge — significant jump in difficulty)
5. Weighted dips (+10 kg → +25 kg)
...
### 4. Pushup — The Horizontal Push

**What it trains:** Chest, triceps, anterior delts, core (anti-extension), serratus anterior.
...
### 6. Kettlebell Swing — The Hip Dominant Pattern

**What it trains:** Posterior chain (glutes, hamstrings), hip extension power, grip (crush + support), core anti-flexion, cardiovascular system.
...
**Progressions:**
1. KB deadlift (learning the hinge pattern)
2. KB swing — two-hand, 16 kg (pattern + power)
3. KB swing — two-hand, 24 kg (load progression)
4. KB swing — two-hand, 32 kg (serious posterior chain)
5. KB swing — one-hand (grip + anti-rotation)
6. KB swing — 40+ kg (long-term, heavy power)

**Two modes in the weekly schedule:**
- **Monday Power Day:** Explosive swings — lighter bell, maximum snap, 4 × 10
- **Thursday Legs + Hinge:** Strength swings — heavier bell, controlled, 5 × 5-8

**Rep targets:**
- Power: 100 swings in 5 minutes (Simple & Sinister test)
...
### 7. Farmer's Carry — The Loaded Carry

**What it trains:** Grip (support + crush), traps, core stability (anti-lateral flexion), shoulder stability, postural endurance, mental toughness.
...
**Why it was added as the 7th compound:**
The original 6 cover pull, push, squat, hinge. But none of them load the body in the WALKING pattern — the most fundamental human movement. The loaded carry fills this gap. It's also the purest grip exercise: hold heavy things until you can't.

**Progressions:**
1. Two-hand farmer's carry — light (16 kg each hand, 30m)
2. Two-hand farmer's carry — moderate (24 kg each hand, 40m)
3. Two-hand farmer's carry — heavy (32 kg each hand, 40m)
4. Suitcase carry — one hand only (anti-lateral flexion emphasis)
5. Bottom-up KB carry (wrist stability + focus)
6. Heavy farmer's carry — 40+ kg each hand (long-term grip/strength)

**Variations that overlap with other goals:**
- **Waiter's walk** (KB overhead, one arm): shoulder stability + overhead range
- **Rack carry** (KB in front rack): core + breathing under load
- **Suitcase carry** (one side only): anti-lateral flexion, oblique strength

**Rep targets:**
- Distance: 40m unbroken with 32 kg each hand
...
## Movement Pattern Completeness Check
...
## How the 7 Compounds Map to the Weekly Schedule
...
The entire IXNAH strength system requires:
...
IXNAH does not chase reps. It chases QUALITY of movement and progressive overload.

**The progression rule:** Master the current level before advancing. "Master" means:
- Full range of motion
- Controlled tempo (no momentum cheating)
- Can perform the target reps with 1-2 reps in reserve
- No pain (discomfort from effort is fine; joint pain is not)

**How to progress each compound:**

| Method | When to Use | Example |
|--------|------------|---------|
| Add reps | When below target rep range | 4 × 6 → 4 × 8 → 4 × 10 |
| Add load | When target reps achieved consistently | Bodyweight dip → +5 kg dip |
| Harder variation | When the exercise gets easy at the target | Pushup → Diamond → Archer → One-arm |
| Grip intensifier | When standard grip is easy | Bar pullup → Towel pullup → Gi pullup |
| Tempo manipulation | For plateaus | 3-second negative, 2-second pause at bottom |

---

## The End State

When all 7 compounds are at mastery level:

- **Pullup:** 15 strict reps OR 5 × weighted at +20 kg
...
*7 movements. No gaps. Grip is the master key. The body becomes the weapon.*
